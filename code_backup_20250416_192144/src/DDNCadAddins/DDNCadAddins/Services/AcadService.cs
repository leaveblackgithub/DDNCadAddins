...
namespace DDNCadAddins.Services
{
    ...
    public class AcadService : IAcadService, IDocumentService, ITransactionService, IBlockReferenceService
    {
        ...
        private readonly IBlockReferenceService _blockReferenceService;
        ...
        public AcadService(ILogger logger)
        {
            ...
            _documentService = new DocumentService(logger);
            _transactionService = new TransactionService(logger);
            _blockReferenceService = new BlockReferenceService(logger, _transactionService);
        }
            ...
            IBlockReferenceService blockReferenceService)
        {
            ...
            _blockReferenceService = blockReferenceService ?? throw new ArgumentNullException(nameof(blockReferenceService));
        }
        
        #region IDocumentService 实现
        ...
        {
            return _documentService.GetMdiActiveDocument();
        }
        ...
        {
            _documentService.ShowAlertDialog(message);
        }
        ...
        {
            return _documentService.GetActiveDocument(out database, out editor);
        }
        ...
        {
            _documentService.WriteMessage(message);
        }
        
        #endregion
        
        #region ITransactionService 实现
        ...
        {
            return _transactionService.ExecuteInTransaction(database, action, errorMessagePrefix);
        }
        ...
        #region IBlockReferenceService 实现
        ...
        {
            return _blockReferenceService.GetBlockReference(tr, blockRefId, openMode);
        }
        ...
        {
            return _blockReferenceService.GetBlockGeometricExtents(blockRef);
        }
        ...
        {
            return _blockReferenceService.GetBlockInfo(tr, blockRef);
        }
        ...
        {
            return _blockReferenceService.CreateTestBlock(tr, blockName, insertionPoint);
        }
        ...
        {
            return _blockReferenceService.FindAllBlockReferences(editor);
        }
        ...
        {
            return _blockReferenceService.IsBlockXClipped(tr, blockRef, out detectionMethod);
        }
        ...
        {
            return _blockReferenceService.ExecuteXClipCommand(blockRefId, minPoint, maxPoint);
        }
