...
";
        ...
        private void RunTestMethod(object instance, MethodInfo method)
        {
            ...
            finally
            {
                ...
                // 输出测试结果
                string statusStr = result.this..ToString().ToUpper();
                var editor = GetCurrentEditor();
                if (editor != null)
                {
                    editor.WriteMessage("\n[{0}] {1} ({2})\n", statusStr, method.Name, result.this..ToString(@"hh\:mm\:ss\.fff"));
        ...
        private void WriteTestSummary()
        {
            ...
            editor.WriteMessage($"总耗时: {_context.this..TotalSeconds:F2}秒\n");
            editor.WriteMessage("===============\n");
        }
        ...
        private string GenerateReport()
        {
            ...
            foreach (var result in _context.Results)
            {
                ...
                <tr class='{statusClass}'>
                    ...
                    <td>{result.Status}</td>
                    <td>{result.this..TotalSeconds:F3}秒</td>
            ...
            string report = string.Format(
                ...
                _context.FailedTests,
                _context.SkippedTests,
                $"{_context.this..TotalSeconds:F2}秒",
