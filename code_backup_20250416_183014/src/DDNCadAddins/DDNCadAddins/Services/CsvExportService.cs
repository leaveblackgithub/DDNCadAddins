    ...
    public class CsvExportService : ICsvExportService
    {
            ...
            string csvFilePath)
        {
            ...
            try
            {
                ...
                if (sortedTags.Contains("Z", StringComparison.Ordinal)) {sortedTags.Remove("Z", StringComparison.Ordinal);}
                if (sortedTags.Contains("Y", StringComparison.Ordinal)) {sortedTags.Remove("Y", StringComparison.Ordinal);}
                if (sortedTags.Contains("X", StringComparison.Ordinal)) {sortedTags.Remove("X", StringComparison.Ordinal);}
                if (sortedTags.Contains("BlockName", StringComparison.Ordinal)) {sortedTags.Remove("BlockName", StringComparison.Ordinal);}
        ...
        private string EscapeCsvField(string field)
        {
            ...
            // 检查是否需要转义
            bool needsEscaping = field.Contains(",", StringComparison.Ordinal) || field.Contains("\"", StringComparison.Ordinal) || 
                                 field.Contains("\r", StringComparison.Ordinal) || field.Contains("\n", StringComparison.Ordinal);
