    ...
    public class CsvExportService : ICsvExportService
    {
            ...
            string csvFilePath)
        {
            ...
            try
            {
                ...
                if (sortedTags.Contains("Z", StringComparison.Ordinal)) {sortedTags.Remove("Z");}
                if (sortedTags.Contains("Y", StringComparison.Ordinal)) {sortedTags.Remove("Y");}
                if (sortedTags.Contains("X", StringComparison.Ordinal)) {sortedTags.Remove("X");}
                if (sortedTags.Contains("BlockName", StringComparison.Ordinal)) {sortedTags.Remove("BlockName");}
